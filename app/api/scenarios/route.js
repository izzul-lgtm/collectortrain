...
function toClientShape(row) {
  return {
    ...
    scoreWeights: row.score_weights || { tone: 1, delivery: 1, counter: 1, action: 1, balance: 1 },
    client: row.client || '',
...
function toDbShape(data) {
  return {
    ...
    score_weights: data.scoreWeights || { tone: 1, delivery: 1, counter: 1, action: 1, balance: 1 },
    client: data.client || '',
